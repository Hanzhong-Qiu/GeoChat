...
#SBATCH --job-name=sl_binomial
#SBATCH --partition=workq
#SBATCH --nodes=4
#SBATCH --gpus=16
#SBATCH --ntasks-per-node=4
#SBATCH --time=11:00:00
#SBATCH --output=/projects/b6ar/dw22963/GeoChat/experiments/logs/ablations/binomial_eta010_%j.out
#SBATCH --error=/projects/b6ar/dw22963/GeoChat/experiments/logs/ablations/binomial_eta010_%j.err
...
# rm -rf ${OUTPUT_DIR}  # disabled to allow checkpoint resumption
...
echo "============================================"
echo "Binomial eta=0.10  |  4 nodes x 4 GH200"
echo "Date        : $(date)"
...
srun --mpi=pmi2 bash -c '
    ...
    python '"${PROJECT_DIR}"'/geochat/train/train_multinode.py \
        ...
        --soft_label_distribution binomial \
        --soft_label_eta 0.10 \
