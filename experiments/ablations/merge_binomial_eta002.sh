...
#SBATCH --job-name=merge_binomial
...
#SBATCH --output=/projects/b6ar/dw22963/GeoChat/experiments/logs/ablations/merge_binomial_eta002_%j.out
#SBATCH --error=/projects/b6ar/dw22963/GeoChat/experiments/logs/ablations/merge_binomial_eta002_%j.err
