...
#SBATCH --job-name=sl_uniform
#SBATCH --partition=workq
#SBATCH --nodes=4
#SBATCH --gpus=16
#SBATCH --ntasks-per-node=4
#SBATCH --time=18:00:00
#SBATCH --output=/projects/b6ar/dw22963/GeoChat/experiments/logs/ablations/uniform_eta005_%j.out
#SBATCH --error=/projects/b6ar/dw22963/GeoChat/experiments/logs/ablations/uniform_eta005_%j.err
...
echo "============================================"
echo "Uniform eta=0.05  |  4 nodes x 4 GH200"
echo "Date        : $(date)"
...
srun --mpi=pmi2 bash -c '
    ...
    python '"${PROJECT_DIR}"'/geochat/train/train_multinode.py \
        ...
        --soft_label_distribution uniform \
        --soft_label_eta 0.05 \
