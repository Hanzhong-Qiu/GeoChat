...
#SBATCH --job-name=hard_baseline
#SBATCH --partition=workq
#SBATCH --nodes=4
#SBATCH --gpus=16
#SBATCH --ntasks-per-node=4
#SBATCH --time=11:00:00
#SBATCH --output=/projects/b6ar/dw22963/GeoChat/experiments/logs/ablations/hard_baseline_isambard_%j.out
#SBATCH --error=/projects/b6ar/dw22963/GeoChat/experiments/logs/ablations/hard_baseline_isambard_%j.err
...
echo "============================================"
echo "Hard baseline (no soft label, Isambard)  |  4 nodes x 4 GH200"
echo "Date        : $(date)"
