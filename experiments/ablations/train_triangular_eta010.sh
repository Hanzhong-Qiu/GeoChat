...
#SBATCH --job-name=sl_triangular
#SBATCH --partition=workq
#SBATCH --nodes=4
#SBATCH --gpus=16
#SBATCH --ntasks-per-node=4
#SBATCH --time=18:00:00
#SBATCH --output=/projects/b6ar/dw22963/GeoChat/experiments/logs/ablations/triangular_eta010_%j.out
#SBATCH --error=/projects/b6ar/dw22963/GeoChat/experiments/logs/ablations/triangular_eta010_%j.err
...
echo "============================================"
echo "Triangular eta=0.10  |  4 nodes x 4 GH200"
echo "Date        : $(date)"
