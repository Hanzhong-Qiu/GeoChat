...
#SBATCH --job-name=merge_triangular
...
#SBATCH --output=/projects/b6ar/dw22963/GeoChat/experiments/logs/ablations/merge_triangular_eta005_%j.out
#SBATCH --error=/projects/b6ar/dw22963/GeoChat/experiments/logs/ablations/merge_triangular_eta005_%j.err
