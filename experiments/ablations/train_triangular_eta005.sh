...
#SBATCH --output=/projects/b6ar/dw22963/GeoChat/experiments/logs/ablations/triangular_eta005_%j.out
#SBATCH --error=/projects/b6ar/dw22963/GeoChat/experiments/logs/ablations/triangular_eta005_%j.err
...
echo "============================================"
echo "Triangular eta=0.05  |  4 nodes x 4 GH200"
echo "Date        : $(date)"
