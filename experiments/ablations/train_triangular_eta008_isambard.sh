...
#SBATCH --job-name=sl_tri008
#SBATCH --partition=workq
#SBATCH --nodes=4
#SBATCH --gpus=16
#SBATCH --ntasks-per-node=4
#SBATCH --time=11:00:00
#SBATCH --output=/projects/b6ar/dw22963/GeoChat/experiments/logs/ablations/triangular_eta008_isambard_%j.out
#SBATCH --error=/projects/b6ar/dw22963/GeoChat/experiments/logs/ablations/triangular_eta008_isambard_%j.err
...
# Per-job Triton cache to avoid NFS stale file handle when multiple DeepSpeed
# jobs share the default ~/.triton/autotune path
...
RUN_TAG=triangular_eta008_isambard
...
# rm -rf ${OUTPUT_DIR}  # commented out to resume from checkpoint
...
echo "============================================"
echo "Triangular eta=0.08 (Isambard retrain)  |  4 nodes x 4 GH200"
echo "Date        : $(date)"
