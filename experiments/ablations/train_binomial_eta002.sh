...
#SBATCH --output=/projects/b6ar/dw22963/GeoChat/experiments/logs/ablations/binomial_eta002_%j.out
#SBATCH --error=/projects/b6ar/dw22963/GeoChat/experiments/logs/ablations/binomial_eta002_%j.err
...
echo "============================================"
echo "Binomial eta=0.02  |  4 nodes x 4 GH200"
echo "Date        : $(date)"
